      ...
      {open ? (
        <div className="flex flex-col items-center justify-between bg-gray-300 dark:bg-zinc-900 rounded-xl h-[500px] w-80 motion-preset-slide-up-left-md">
          ...
          >
            {messages.length ? (
                ...
                <div key={message.id}>
                  {message.role === "assistant" ? (
                    <h3 className="text-md  font-semibold mt-4 items-center flex gap-2 font-mono">
                      ...
                      <span className="block font-light text-gray-700 dark:text-gray-300">
                        bot
                      </span>
                    </h3>
                  ) : (
              ...
              <div className="w-full h-full flex flex-col justify-center items-center font-mono dark:text-white">
                <h1>Ask anything about coffee</h1>
                <CoffeeIcon size={30} />
              </div>
            )}
          </div>
          ...
          >
            ...
            <Button
              type="submit"
              className="bg-white hover:bg-slate-200 px-3 dark:bg-zinc-900 dark:hover:bg-zinc-800"
            >
